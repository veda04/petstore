                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            <div class="header__top__right__auth">
                                <a href="registration.html"><i class="fa fa-user"></i> Login</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="header__menu__dropdown">
                                    ...
                                    <li><a href="./shoping-cart.html">Food</a></li>
                                    <li><a href="./checkout.html">Toys</a></li>
                                </ul>
                            </li>
            ...
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post">
                    ...
                    <div class="text-center">
                        <p class="small">Don't have an account? <a href="">Register</a></p>
                    </div>
                </form>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer__about">
                            ...
                            <ul>
                                <li>Address: Kings Bridge Road, Huddersfield, UK, HD1 3DG</li>
                                <li>Phone: +65 11.188.888</li>
                                <li>Email: hello@petstore.com</li>
                            </ul>
                        </div>
                    </div>
